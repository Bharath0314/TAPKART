<%@ page import="com.tapkart.daoimpl.UserDaoImpl"%>
...
<body>
	<div>
		<video class="video-background" autoplay muted loop> <source
			src="videoplayback  new.mp4" type="video/mp4"> Your browser
	...
	<form action="CallingSignUpServlet" method="post">
		...
		<h5>
			Already have an account? <a href="Login.jsp">Login to your
				account  </a><button id="seller"><a href="RestaurantSignUp.jsp">🏛️Become a Seller</a></button>
				<button id="seller"><a href="AgentSignUp.jsp">👨🏻‍💼Delivery Agent</a></button>
		</h5>
