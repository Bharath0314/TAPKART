...
<body>
    <header class="header">
        ...
        <div class="nav-buttons">
            ...
            <button><i class="fas fa-shopping-cart"></i><a href="CallingCartServlet" style="text-decoration: none; color: white;">Cart</a></button>
            <button><i class="fas fa-user"></i><a href="Logged" style="color:white; text-decoration: none;">Login</a></button>
            <button><i class="fas fa-user"></i> <a href="SignUp.jsp" style="color:white; text-decoration: none;">SignUp</a></button>
        </div>
    </header>
